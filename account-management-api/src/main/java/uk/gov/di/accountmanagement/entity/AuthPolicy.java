...
public class AuthPolicy {
     ...
     * using camel case
     *
     * <p>This method implements a custom serializer to return the IAM Policy as a well-formed JSON
    ...
    /**
     * PolicyDocument represents an IAM Policy, specifically for the execute-api:Invoke action in
     * the context of a API Gateway Authorizer
     *
     * <p>Initialize the PolicyDocument with the region where the RestApi is configured, the AWS
     * Account ID that owns the RestApi, the RestApi identifier and the Stage on the RestApi that
    ...
    public static class PolicyDocument {
        ...
        private void addResourceToStatement(
                Statement statement, HttpMethod httpMethod, String resourcePath) {
