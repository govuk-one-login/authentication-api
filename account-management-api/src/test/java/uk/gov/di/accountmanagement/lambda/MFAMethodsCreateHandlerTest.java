...
class MFAMethodsCreateHandlerTest {
    ...
    class SuccessfulRequest {
        ...
        void shouldReturn200AndCreateAuthAppMfa() throws Json.JsonException {
            ...
            var defaultMfa = MFAMethod.authAppMfaMethod(
                    "cred",
                    true,
                    true,
            ...
            when(mfaMethodsService.getMfaMethods(TEST_EMAIL)).thenReturn(Result.success(List.of(defaultMfa)));
    ...
    class FailedRequest {
        ...
        void shouldReturn500WhenReturnedMfaMethodDoesNotConvertToMfaResponse() {
            ...
            var defaultMfa = MFAMethod.smsMfaMethod(
                    true,
                    true,
                    TEST_PHONE_NUMBER,
                    PriorityIdentifier.DEFAULT,
