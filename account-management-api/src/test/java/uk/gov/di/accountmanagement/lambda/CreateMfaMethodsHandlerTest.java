...
public class CreateMfaMethodsHandlerTest {
    ...
    void shouldReturn200ForSuccessfulRequest() {
        ...
        Map<String, Object> requestBodyMap = getStringObjectMap(mfaMethod);

        try {
            event.setBody(objectMapper.writeValueAsString(requestBodyMap));
