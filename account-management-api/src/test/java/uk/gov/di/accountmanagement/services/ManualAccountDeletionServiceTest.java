...
class ManualAccountDeletionServiceTest {
    ...
    private final UserProfile USER_PROFILE = mock(UserProfile.class);
    private final String PUBLIC_SUBJECT_ID = "publicSubject";
    private final String LEGACY_SUBJECT_ID = "legacySubject";
    private final String SUBJECT_ID = "subjectId";
    private final String COMMON_SUBJECT_ID =
    ...
    void shouldCallRemoveAccountWithCorrectParameters() throws Json.JsonException {
        ...
        verify(accountDeletionService)
                .removeAccount(
                        Optional.empty(), USER_PROFILE, AuditService.RestrictedSection.empty);
    }
