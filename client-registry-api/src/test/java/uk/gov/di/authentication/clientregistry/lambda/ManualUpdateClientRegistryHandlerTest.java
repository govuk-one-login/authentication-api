...
class ManualUpdateClientRegistryHandlerTest {
    ...
    @Test
    public void shouldReturnResultSuccessForAValidRequest() {
        ...
        when(clientService.updateClientFromAWS(
        ...
        assertThat(result.get(MESSAGE_KEY), equalTo("Successfully updated client"));
    }
    ...
    @Test
    public void shouldReturnResultErrorWhenRequestIsMissingClientID() {
    ...
    @Test
    public void shouldReturnResultErrorWhenClientIdIsInvalid() {
    ...
    @Test
    public void shouldReturnResultErrorWhenRequestFailsValidation() {
        when(clientService.isValidClient(CLIENT_ID)).thenReturn(true);
        when(clientValidationService.validateManualUpdateClientRegistryRequest(
                        any(ManualUpdateClientRegistryRequest.class)))
