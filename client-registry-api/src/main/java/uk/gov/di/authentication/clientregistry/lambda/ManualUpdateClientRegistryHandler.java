...
public class ManualUpdateClientRegistryHandler
    ...
    public Map<String, String> handleRequest(Object input, Context context) {
        ...
        try {
            ...
            var clientId = manualUpdateClientRegistryRequest.getClientId();
            ...
            clientService.updateClientFromAWS(clientId, manualUpdateClientRegistryRequest);

            LOG.info("Client updated");
            response.put(RESULT_KEY, RESULT_SUCCESS);
            response.put(MESSAGE_KEY, "Successfully updated client");
            return response;
