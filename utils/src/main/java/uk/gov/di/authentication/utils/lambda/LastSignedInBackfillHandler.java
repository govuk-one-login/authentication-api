...
public class LastSignedInBackfillHandler
    ...
    private volatile long runningUpdatedCount = 0;
    private volatile long runningSkippedCount = 0;
    ...
    protected void onInvocationComplete(
        ...
        runningUpdatedCount += updated;
        runningSkippedCount += skipped;
    ...
    protected LastSignedInBackfillResponse buildResponse(long processedCount) {
        return new LastSignedInBackfillResponse(
                processedCount, runningUpdatedCount, runningSkippedCount);
    }
