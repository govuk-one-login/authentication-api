...
class ChainedParallelScanHelperTest {
    ...
    @Test
    void toDynamoKeysShouldReturnEmptyMapForNullInput() {
        var result = ChainedParallelScanHelper.toDynamoKeys(null);
        assertNotNull(result);
        assertTrue(result.isEmpty());
    }

    @Test
    void toDynamoKeysShouldReturnEmptyMapForEmptyMap() {
        var result = ChainedParallelScanHelper.toDynamoKeys(Map.of());
        assertNotNull(result);
        assertTrue(result.isEmpty());
    }
