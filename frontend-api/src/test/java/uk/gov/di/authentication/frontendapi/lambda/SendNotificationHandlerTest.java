...
class SendNotificationHandlerTest {
    ...
    void shouldReturn400IfUserIsBlockedFromRequestingAnyMorePhoneOtpCodes() {
        when(codeStorageService.isBlockedForEmail(
                        EMAIL, CODE_REQUEST_BLOCKED_KEY_PREFIX + CodeRequestType.MFA_REGISTRATION))
                .thenReturn(true);
        usingValidSession();
    ...
    @Test
    void shouldReturn400IfUserIsBlockedFromRequestingAnyMorePhoneOtpCodesWithDeprecatedPrefix() {
        when(codeStorageService.isBlockedForEmail(
                        EMAIL,
