...
@PactConsumerTest
@MockServerConfig(hostInterface = "localHost", port = "3010")
class IpvTokenTest {
    ...
    private static final String PRIVATE_JWT_KEY =
            String.format(
                    "{\"kty\":\"EC\",\"d\":\"4NLo4B5Oj5E_ga6-eYjTSehss85p_mL799NRQqmll64\",\"crv\":\"P-256\",\"kid\":\"%s\",\"x\":\"emDeRQ0KISC_TdfkoAZdd4lWm2Nk5UOtmmboLEab850\",\"y\":\"-Ua4zzSzMG5lgpMyZoURg6Au60mHSxgnnf9pDtJmE2w\",\"alg\":\"ES256\"}",
                    KEY_ID_HASHED);
