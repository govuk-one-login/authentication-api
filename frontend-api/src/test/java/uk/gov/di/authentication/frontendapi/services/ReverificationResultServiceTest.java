...
class ReverificationResultServiceTest {
    ...
    @Test
    void shouldCallIPVReverificationRequestAndParseCorrectly()
        ...
        assertThat(
                reverificationResult.getSubject().getValue(),
                equalTo("urn:uuid:f81d4fae-7dec-11d0-a765-00a0c91e6bf6"));
        assertThat(reverificationResult.getClaim("success"), equalTo(true));
    }
