...
public class MfaResetAuthorizeHandler extends BaseFrontendHandler<MfaResetRequest>
    ...
    public APIGatewayProxyResponseEvent handleRequestWithUserContext(
        ...
        try {
            ...
            attachSessionIdToLogs(userSession.getSessionId());
            ...
            return mfaResetIPVAuthorizationService.sendMfaResetRequestToIPV(
                    internalCommonSubjectId, clientSessionId, userSession, auditContext);
        } catch (Exception e) {
            LOG.error("Error generating MFA reset Authorization JAR", e);
