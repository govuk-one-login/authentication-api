...
public class CheckReAuthUserHandler extends BaseFrontendHandler<CheckReauthUserRequest>
    ...
    private APIGatewayProxyResponseEvent generateErrorResponse(
        ...
        String commonSubjectId = userContext.getSession().getInternalCommonSubjectIdentifier();
        ...
        auditService.submitAuditEvent(
                ...
                pair("user_supplied_email", email),
                pair("user_id_for_user_supplied_email", commonSubjectId),
                pair("rp_pairwise_id", pairwiseId));
