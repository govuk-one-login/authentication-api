...
public class MfaResetIPVAuthorizationService {
    ...
    private static final String STATE_STORAGE_PREFIX = "state:";
    ...
    public APIGatewayProxyResponseEvent sendMfaResetRequestToIPV(
        ...
        return generateApiGatewayProxyResponse(
                302, "", Map.of(ResponseHeaders.LOCATION, ipvAuthorisationRequestURI), null);
    }
    ...
    private EncryptedJWT constructMfaResetAuthorizationJWT(
        ...
        SignedJWT signedJWT =
                jwtService.signJWT(
                        ...
                        configurationService.getMfaResetJarSigningKeyAlias());
