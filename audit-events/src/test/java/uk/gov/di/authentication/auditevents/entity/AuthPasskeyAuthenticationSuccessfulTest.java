...
class AuthPasskeyAuthenticationSuccessfulTest {
    @Test
    void shouldSerialiseAnAuthPasskeyAuthenticationSuccessfulAuditEvent() {
        var auditContext =
        ...
        var event =
                AuthPasskeyAuthenticationSuccessful.create(
                        auditContext, passkey, "credential-id", JourneyType.SIGN_IN, fixedClock);
        ...
        var expectedEvent =
                """
                        {
                           "event_name": "AUTH_PASSKEY_AUTHENTICATION_SUCCESSFUL",
