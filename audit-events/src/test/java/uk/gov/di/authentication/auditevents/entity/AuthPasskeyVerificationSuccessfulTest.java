...
class AuthPasskeyVerificationSuccessfulTest {
    ...
    void shouldSerialiseAnAuthPasskeyVerificationSuccessfulAuditEvent() {
        ...
        var passkeyAllowCredentials =
                List.of(
                        new AuthPasskeyVerificationSuccessful.PasskeyAllowedCredential(
                                "credential-1", null),
                        new AuthPasskeyVerificationSuccessful.PasskeyAllowedCredential(
                                "credential-2", List.of("ble")));
        var passkey =
                new AuthPasskeyVerificationSuccessful.Passkey(
                        ...
                        "multi-device",
                        true,
                        new AuthPasskeyVerificationSuccessful.PasskeyAuthenticationRequest(
                                "required"));
        var event =
