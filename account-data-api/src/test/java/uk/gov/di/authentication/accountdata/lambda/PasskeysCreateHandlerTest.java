...
class PasskeysCreateHandlerTest {
    ...
    private final PasskeysCreateService passkeyService = mock(PasskeysCreateService.class);
    ...
    class Error {
        ...
        //            handler = new PasskeysCreateHandler(configurationService, passkeyService);
        ...
        //            assertThat(result,
        // hasJsonBody(ErrorResponse.UNEXPECTED_ACCOUNT_DATA_API_ERROR));
        //        }
    }
