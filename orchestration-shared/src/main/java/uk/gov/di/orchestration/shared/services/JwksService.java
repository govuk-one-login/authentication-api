...
public class JwksService {
    ...
    public JWK getPublicTokenJwkWithOpaqueId() {
        ...
        return getPublicJWKWithKeyId(configurationService.getIdTokenSigningKeyAlias());
    }

    public JWK getPublicTokenRsaJwkWithOpaqueId() {
        LOG.info("Retrieving RSA public key");
        return getPublicJWKWithKeyId(configurationService.getIdTokenSigningKeyRsaAlias());
    }
