...
public class DestroySessionsRequest {
    ...
    public DestroySessionsRequest(String sessionId, Session session, OrchSessionItem orchSession) {
        this(sessionId, orchSession.getClientSessions(), session.getEmailAddress());
    }
