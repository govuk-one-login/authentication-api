...
/** VoT Code Representing a {@link CredentialTrustLevel} */
...
public class CredentialTrustLevelCode extends VotComponentCode<CredentialTrustLevelId> {
    ...
    public static final CredentialTrustLevelCode C3 =
            CredentialTrustLevelCode.of(CredentialTrustLevelId.C3);
    public static final CredentialTrustLevelCode C4 =
            CredentialTrustLevelCode.of(CredentialTrustLevelId.C4);
