...
public class JwksCacheItem {
    ...
    public JwksCacheItem(String jwksUrl, String keyId, long expirationInSeconds, KeyUse keyUse) {
        this.jwksUrl = jwksUrl;
        this.keyId = keyId;
        this.timeToLive = expirationInSeconds;
        this.keyUse = keyUse.getValue();
    }

    public JwksCacheItem(String jwksUrl, String keyId, long expirationInSeconds) {
        this(jwksUrl, keyId, expirationInSeconds, KeyUse.ENCRYPTION);
    }
