...
public class MfaHelper {
    ...
    public static boolean mfaRequired(List<VectorOfTrust> vectorsOfTrust) {
        return vectorsOfTrust.stream()
                .allMatch(vot -> vot.getCredentialTrustLevel().equals(MEDIUM_LEVEL));
    }
