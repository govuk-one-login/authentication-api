...
class VtrListTest {
    ...
    static Stream<Arguments> requiresIdentityTestCases() {
        return Stream.of(
                ...
                arguments(VtrList.of(VOT_P2_CL_CM, VOT_PCL250_CL_CM, VOT_P0_CL), false));
    }
    ...
    void getSelectedLevelsOfConfidencesReturnCorrectValue() {
        var vtrList1 = VtrList.of(VOT_P2_CL_CM, VOT_CL);
        assertThat(
                vtrList1.getLevelsOfConfidence(),
                is(equalTo(List.of(LevelOfConfidence.NONE, LevelOfConfidence.MEDIUM_LEVEL))));
    ...
    void ShouldSerializeCorrectly() {
        ...
        var actualJson = GSON.toJson(VtrList.of(VOT_P2_CL_CM, VOT_PCL250_CL_CM, VOT_CL));
    ...
    void ShouldDeserializeCorrectly() {
        var expectedVtrList = VtrList.of(VOT_P2_CL_CM, VOT_PCL250_CL_CM, VOT_CL);
