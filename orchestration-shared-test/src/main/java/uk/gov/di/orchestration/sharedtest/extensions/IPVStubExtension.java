    ...
    public void init() {
        ...
        register(
                ...
                "{"
                        ...
                        + "  \"https://vocab.account.gov.uk/v1/returnCode\": [{\"code\":\"A\"},{\"code\":\"P\"}]"
                        + "}");
    }

    public void initWithValidLoCAndReturnCode() {
        register(
                "/token",
                200,
                "application/json",
        ...
        register(
                ...
                "{"
                        ...
                        + "  \"https://vocab.account.gov.uk/v1/socialSecurityRecord\": [{\"socialSecurityRecord\":[{\"personalNumber\":\"LR850265D\"}]}],"
                        + "  \"https://vocab.account.gov.uk/v1/passport\": [{\"documentNumber\":\"1223456\",\"expiryDate\":\"2022-02-02\"}],"
                        + "  \"https://vocab.account.gov.uk/v1/returnCode\": [{\"code\":\"A\"}]"
                        + "}");
    }

    public void initWithInvalidLoCAndReturnCode() {
        register(
                "/token",
                200,
                "application/json",
        ...
        register(
                ...
                "{"
                        ...
                        + "  \"https://vocab.account.gov.uk/v1/socialSecurityRecord\": [{\"socialSecurityRecord\":[{\"personalNumber\":\"LR850265D\"}]}],"
                        + "  \"https://vocab.account.gov.uk/v1/passport\": [{\"documentNumber\":\"1223456\",\"expiryDate\":\"2022-02-02\"}],"
                        + "  \"https://vocab.account.gov.uk/v1/returnCode\": [{\"code\":\"Z\"}]"
                        + "}");
    }
}
