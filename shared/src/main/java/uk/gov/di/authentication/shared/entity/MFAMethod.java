    ...
    AttributeValue toAttributeValue() {
        return AttributeValue.fromM(
                Map.ofEntries(
                        ...
                        Map.entry(ATTRIBUTE_DESTINATION, AttributeValue.fromS(getDestination())),
                        Map.entry(
                                ATTRIBUTE_MFA_IDENTIFIER,
                                AttributeValue.fromN(getMfaIdentifier().toString())),
                        Map.entry(ATTRIBUTE_PRIORITY, AttributeValue.fromS(getPriority()))));
    }
