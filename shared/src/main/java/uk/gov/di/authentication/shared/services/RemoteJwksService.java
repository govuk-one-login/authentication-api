...
public class RemoteJwksService {
    ...
    public RemoteJwksService(JWKSource<SecurityContext> jwkSource) {
        this.jwkSource = jwkSource;
    }

    public static RemoteJwksService fromUrl(URL url) {
        return new RemoteJwksService(
    ...
    public JWK retrieveJwkFromURLWithKeyId(String keyId) throws KeySourceException {
        ...
        LOG.info("Retrieving JWKSet from URL");
