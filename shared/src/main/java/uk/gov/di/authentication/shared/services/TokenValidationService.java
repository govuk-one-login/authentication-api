...
public class TokenValidationService {
    ...
    public boolean isTokenSignatureValid(String tokenValue) {
        try {
            ...
            if (JWSAlgorithm.RS256 == jwt.getHeader().getAlgorithm()
                ...
                return signingKeys.anyMatch(key -> isSignatureValidWithKey(jwt, key));
            }
    ...
    private boolean isSignatureValidWithKey(SignedJWT jwt, JWK trustedKey) {
        try {
            return jwt.verify(new ECDSAVerifier(trustedKey.toECKey()));
