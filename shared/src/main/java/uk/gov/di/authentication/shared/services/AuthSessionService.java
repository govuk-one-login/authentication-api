...
public class AuthSessionService extends BaseDynamoService<AuthSessionItem> {
    ...
    public void updateSessionAttribute(String sessionId, String attributeToUpdate, String value) {
        ...
        var updateExpression = "SET %s = %s".formatted(attributeNameToUpdatePlaceholder, attributeValueToUpdatePlaceholder);
            ...
            update(
                    UpdateItemRequest.builder()
                            ...
                            .expressionAttributeNames(Map.of(
                                    attributeNameToUpdatePlaceholder, attributeToUpdate,
                                    "#SessionId", AuthSessionItem.ATTRIBUTE_SESSION_ID
                            ))
                            .expressionAttributeValues(Map.of(
                                    attributeValueToUpdatePlaceholder, AttributeValue.fromS(value)
                            ))
                            .build());
        } catch (Exception e) {
            logAndThrowAuthSessionException(
                    "Failed to update Auth session attribute %s".formatted(attributeToUpdate), sessionId, e);
        }
    }
