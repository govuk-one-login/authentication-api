...
public class AuthSessionItem {
    ...
    public AuthSessionItem() {
        ...
        this.preservedReauthCountsForAuditMap = new HashMap<>();
        initializeCodeRequestMap();
        initializePreservedReauthCountsForAuditMap();
    }
    ...
    public AuthSessionItem resetPreservedReauthCountsForAudit() {
        for (CountType countType : CountType.values()) {
            preservedReauthCountsForAuditMap.put(countType, 0);
        }
        return this;
    }

    private void initializePreservedReauthCountsForAuditMap() {
        for (CountType countType : CountType.values()) {
            preservedReauthCountsForAuditMap.put(countType, 0);
        }
    }
