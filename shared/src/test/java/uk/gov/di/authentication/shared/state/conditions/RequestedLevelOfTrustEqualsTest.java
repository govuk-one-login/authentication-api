...
class RequestedLevelOfTrustEqualsTest {
    ...
    @Test
    public void shouldReturnTrueIfRequestedLevelOfTrustMatches() {
        RequestedLevelOfTrustEquals condition = new RequestedLevelOfTrustEquals(MEDIUM_LEVEL);
    ...
    @Test
    public void shouldReturnFalseIfRequestedLevelOfTrustDoesNotMatch() {
        RequestedLevelOfTrustEquals condition = new RequestedLevelOfTrustEquals(MEDIUM_LEVEL);
