...
import uk.gov.di.accountmanagement.lambda.RetrieveMfaMethodsHandler;
...
public class RetrieveMfaMethodsListIntegrationTest extends ApiGatewayHandlerIntegrationTest {
    ...
    void setup() throws JOSEException, NoSuchAlgorithmException, Json.JsonException {
        ...
        handler = new RetrieveMfaMethodsHandler();
    }
