...
import uk.gov.di.accountmanagement.lambda.UpdateMfaMethodHandler;
...
public class UpdateMfaMethodIntegrationTest extends ApiGatewayHandlerIntegrationTest {
    ...
    void setup() throws JOSEException, NoSuchAlgorithmException, Json.JsonException {
        ...
        handler = new UpdateMfaMethodHandler();
    }
