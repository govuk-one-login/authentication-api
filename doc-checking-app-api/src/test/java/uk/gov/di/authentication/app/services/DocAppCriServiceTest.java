...
class DocAppCriServiceTest {
    ...
    private final DocAppCriAPI docAppBackendApi = mock(DocAppCriAPI.class);
    ...
    @BeforeEach
    void setUp() {
        docAppCriService = new DocAppCriService(configService, kmsService, docAppBackendApi);
        when(docAppBackendApi.tokenURI()).thenReturn(TOKEN_URI);
