...
public class DocAppCallbackHandler
    ...
    private final DocAppBackendAPI docAppBackendApi;
    ...
    public DocAppCallbackHandler(
            ...
            DocAppBackendAPI docAppBackendApi) {
        ...
        this.docAppBackendApi = docAppBackendApi;
    }

    public DocAppCallbackHandler(ConfigurationService configurationService) {
        var kmsConnectionService = new KmsConnectionService(configurationService);
        var docAppBackendApi = new DocAppBackendAPI(configurationService);
        this.configurationService = configurationService;
        ...
        this.tokenService =
                new DocAppCriService(configurationService, kmsConnectionService, docAppBackendApi);
        ...
        this.docAppBackendApi = new DocAppBackendAPI(configurationService);
    }
    ...
    public APIGatewayProxyResponseEvent docAppCallbackRequestHandler(
        ...
        try {
            ...
            try {
                var criDataURI = docAppBackendApi.criDataURI();
