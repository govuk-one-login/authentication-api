...
This is the same as [endpoint-module-v2](../endpoint-module-v2/), except it uses [endpoint-lambda-snapstart](../endpoint-lambda-snapstart/).

This should be used _only_ when enabling snapstart on a previously PC'd lambda. It's less fault-tolerant than the bare [endpoint-module-v2](../endpoint-module-v2/) when Provisioned concurrency is enabled.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_endpoint_lambda"></a> [endpoint\_lambda](#module\_endpoint\_lambda) | ../endpoint-lambda-snapstart | n/a |
