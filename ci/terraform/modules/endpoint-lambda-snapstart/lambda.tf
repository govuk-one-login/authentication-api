resource "aws_lambda_function" "endpoint_lambda" {
  ...
  # checkov:skip=CKV_AWS_116:We do not want DLQ on this Lambda
}
...
resource "aws_cloudwatch_log_group" "lambda_log_group" {
  ...
  #checkov:skip=CKV_AWS_338:We ship logs & retain elsewhere
}
...
resource "aws_appautoscaling_target" "lambda_target" {
  ...
  resource_id        = "function:${aws_lambda_function.endpoint_lambda.function_name}:${aws_lambda_function.endpoint_lambda.version}"
