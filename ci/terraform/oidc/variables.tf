...
variable "orch_processing_identity_enabled" {
  description = "Flag to enable routing processing identity endpoint traffic to the orchestration account"
  type        = bool
  default     = false
}
...
variable "orch_processing_identity_name" {
  type    = string
  default = ""
}
