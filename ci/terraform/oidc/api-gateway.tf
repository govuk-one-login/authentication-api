...
resource "aws_api_gateway_method" "orch_doc_app_callback_method" {
  rest_api_id = aws_api_gateway_rest_api.di_authentication_api.id
  resource_id = aws_api_gateway_resource.orch_doc_app_callback_resource.id
  http_method = "GET"
...
resource "aws_api_gateway_integration" "orch_doc_app_callback_integration" {
  rest_api_id = aws_api_gateway_rest_api.di_authentication_api.id
  resource_id = aws_api_gateway_resource.orch_doc_app_callback_resource.id
  http_method = aws_api_gateway_method.orch_doc_app_callback_method.http_method
  depends_on = [
    aws_api_gateway_resource.orch_doc_app_callback_resource
  ]
  type                    = "AWS_PROXY"
...
resource "aws_api_gateway_method" "orch_token_method" {
  rest_api_id = aws_api_gateway_rest_api.di_authentication_api.id
  resource_id = aws_api_gateway_resource.orch_token_resource.id
  http_method = "POST"
...
resource "aws_api_gateway_integration" "orch_token_integration" {
  rest_api_id = aws_api_gateway_rest_api.di_authentication_api.id
  resource_id = aws_api_gateway_resource.orch_token_resource.id
  http_method = aws_api_gateway_method.orch_token_method.http_method
  depends_on = [
    aws_api_gateway_resource.orch_token_resource
  ]
  type                    = "AWS_PROXY"
...
resource "aws_api_gateway_method" "orch_jwks_method" {
  rest_api_id = aws_api_gateway_rest_api.di_authentication_api.id
  resource_id = aws_api_gateway_resource.orch_jwks_resource.id
  http_method = "GET"
...
resource "aws_api_gateway_integration" "orch_jwks_integration" {
  rest_api_id = aws_api_gateway_rest_api.di_authentication_api.id
  resource_id = aws_api_gateway_resource.orch_jwks_resource.id
  http_method = aws_api_gateway_method.orch_jwks_method.http_method
  depends_on = [
    aws_api_gateway_resource.orch_jwks_resource
  ]
  type                    = "AWS_PROXY"
...
resource "aws_api_gateway_method" "orch_auth_code_method" {
  rest_api_id = aws_api_gateway_rest_api.di_authentication_api.id
  resource_id = aws_api_gateway_resource.orch_auth_code_resource.id
  http_method = "GET"
...
resource "aws_api_gateway_method" "orch_logout_method" {
  rest_api_id = aws_api_gateway_rest_api.di_authentication_api.id
  resource_id = aws_api_gateway_resource.orch_logout_resource.id
  http_method = "GET"
...
resource "aws_api_gateway_integration" "orch_logout_integration" {
  rest_api_id = aws_api_gateway_rest_api.di_authentication_api.id
  resource_id = aws_api_gateway_resource.orch_logout_resource.id
  http_method = aws_api_gateway_method.orch_logout_method.http_method
  depends_on = [
    aws_api_gateway_resource.orch_logout_resource
  ]
  type                    = "AWS_PROXY"
...
resource "aws_api_gateway_method" "orch_ipv_callback_method" {
  rest_api_id = aws_api_gateway_rest_api.di_authentication_api.id
  resource_id = aws_api_gateway_resource.orch_ipv_callback_resource.id
  http_method = "GET"
...
resource "aws_api_gateway_integration" "orch_ipv_callback_integration" {
  rest_api_id = aws_api_gateway_rest_api.di_authentication_api.id
  resource_id = aws_api_gateway_resource.orch_ipv_callback_resource.id
  http_method = aws_api_gateway_method.orch_ipv_callback_method.http_method
  depends_on = [
    aws_api_gateway_resource.orch_ipv_callback_resource
  ]
  type                    = "AWS_PROXY"
...
resource "aws_api_gateway_integration" "orch_auth_code_integration" {
  rest_api_id = aws_api_gateway_rest_api.di_authentication_api.id
  resource_id = aws_api_gateway_resource.orch_auth_code_resource.id
  http_method = aws_api_gateway_method.orch_auth_code_method.http_method
  depends_on = [
    aws_api_gateway_resource.orch_auth_code_resource
  ]
  type                    = "AWS_PROXY"
