...
module "mfa_reset_jar_signing_jwk" {
  ...
  handler_environment_variables = {
    ...
    IPV_REVERIFICATION_REQUESTS_SIGNING_KEY_DEPRECATED_ALIAS = var.environment != "integration" && var.environment != "production" ? aws_kms_alias.ipv_reverification_request_signing_key_deprecated_alias[0].name : null
  }
