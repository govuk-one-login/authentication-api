...
#}
# moved {
#   from = aws_cloudwatch_metric_alarm.waf_oidc_blocked_request_cloudwatch_alarm[0]
#   to   = aws_cloudwatch_metric_alarm.waf_oidc_blocked_request_cloudwatch_alarm
# }
...
#}
# moved {
#   from = aws_cloudwatch_metric_alarm.waf_frontend_blocked_request_cloudwatch_alarm[0]
#   to   = aws_cloudwatch_metric_alarm.waf_frontend_blocked_request_cloudwatch_alarm
# }
