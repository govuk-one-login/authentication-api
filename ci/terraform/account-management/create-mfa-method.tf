module "account_management_api_create_mfa_methods" {
  source      = "../modules/lambda-role"
  environment = var.environment
  role_name   = "account-management-api-create-mfa_method"
...
module "create-mfa-method" {
  source = "../modules/endpoint-module"

  endpoint_name   = "mfa-methods"
  path_part       = "mfa-methods"
  ...
  memory_size                 = lookup(var.performance_tuning, "create-mfa-method", local.default_performance_parameters).memory
  provisioned_concurrency     = lookup(var.performance_tuning, "create-mfa-method", local.default_performance_parameters).concurrency
  max_provisioned_concurrency = lookup(var.performance_tuning, "create-mfa-method", local.default_performance_parameters).max_concurrency
  scaling_trigger             = lookup(var.performance_tuning, "create-mfa-method", local.default_performance_parameters).scaling_trigger
