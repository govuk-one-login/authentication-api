module "account_management_api_mfa_methods_update_role" {
  ...
  role_name   = "account_management_api_mfa_methods_update_role"
...
module "mfa-methods-update" {
  source = "../modules/endpoint-lambda"

  endpoint_name = "mfa-methods-update"
  ...
  handler_function_name = "uk.gov.di.accountmanagement.lambda.MFAMethodsPutHandler::handleRequest"

  memory_size                 = lookup(var.performance_tuning, "mfa-methods-update", local.default_performance_parameters).memory
  provisioned_concurrency     = lookup(var.performance_tuning, "mfa-methods-update", local.default_performance_parameters).concurrency
  max_provisioned_concurrency = lookup(var.performance_tuning, "mfa-methods-update", local.default_performance_parameters).max_concurrency
  scaling_trigger             = lookup(var.performance_tuning, "mfa-methods-update", local.default_performance_parameters).scaling_trigger
  ...
  environment                            = var.environment
  lambda_role_arn                        = module.account_management_api_mfa_methods_update_role.arn
