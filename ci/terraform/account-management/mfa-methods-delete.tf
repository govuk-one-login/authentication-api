module "account_management_api_mfa_methods_delete_role" {
  ...
  role_name   = "account_management_api_mfa_methods_delete_role"
...
module "mfa-methods-delete" {
  ...
  handler_function_name = "uk.gov.di.accountmanagement.lambda.MFAMethodsDeleteHandler::handleRequest"

  memory_size                 = lookup(var.performance_tuning, "mfa-methods-delete", local.default_performance_parameters).memory
  provisioned_concurrency     = lookup(var.performance_tuning, "mfa-methods-delete", local.default_performance_parameters).concurrency
  max_provisioned_concurrency = lookup(var.performance_tuning, "mfa-methods-delete", local.default_performance_parameters).max_concurrency
  scaling_trigger             = lookup(var.performance_tuning, "mfa-methods-delete", local.default_performance_parameters).scaling_trigger
