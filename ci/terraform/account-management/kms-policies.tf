...
resource "aws_kms_alias" "test_id_token_signing_key_alias" {
  ...
  target_key_id = aws_kms_key.test_id_token_signing_key.key_id
}
...
data "aws_iam_policy_document" "test_id_token_signing_key_access_policy" {
  statement {
    ...
    resources = [aws_kms_key.test_id_token_signing_key.arn]
...
resource "aws_kms_key_policy" "test_id_token_signing_key_policy" {
  key_id = aws_kms_key.test_id_token_signing_key.id
  policy = data.aws_iam_policy_document.test_id_token_signing_key_access_policy.json
}
