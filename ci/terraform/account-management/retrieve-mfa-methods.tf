module "account_management_api_retrieve_mfa_methods_role" {
...
module "retrieve-mfa-methods" {
  ...
  endpoint_name = "retrieve-mfa-methods"
  ...
  environment                            = var.environment
  lambda_role_arn                        = module.account_management_api_retrieve_mfa_methods_role.arn
