...
module "delete-mfa-methods" {
  ...
  max_provisioned_concurrency = lookup(var.performance_tuning, "delete-mfa-methods", local.default_performance_parameters).max_concurrency
  scaling_trigger             = lookup(var.performance_tuning, "delete-mfa-methods", local.default_performance_parameters).scaling_trigger
