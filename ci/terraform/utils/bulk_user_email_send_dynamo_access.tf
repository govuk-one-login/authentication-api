...
data "aws_iam_policy_document" "bulk_user_email_send_dynamo_encryption_key_policy_document" {
  count = local.deploy_bulk_email_users_count
  statement {
...
resource "aws_iam_policy" "bulk_user_email_send_dynamo_encryption_key_kms_policy" {
  count       = local.deploy_bulk_email_users_count
  ...
  policy = data.aws_iam_policy_document.bulk_user_email_send_dynamo_encryption_key_policy_document[0].json
}