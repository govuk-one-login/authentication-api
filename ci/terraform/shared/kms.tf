...
moved {
  from = data.aws_iam_policy_document.kms_policy_document[0]
  to   = data.aws_iam_policy_document.kms_policy_document
}
...
moved {
  from = data.aws_iam_policy_document.kms_signing_policy_document[0]
  to   = data.aws_iam_policy_document.kms_signing_policy_document
}
