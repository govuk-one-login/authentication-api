...
stub_rp_clients = [
  {
    ...
    back_channel_logout_uri = "https://rp-build.build.stubs.account.gov.uk/backchannel_logout"
    test_client             = "0"
    client_type             = "web"
    scopes = [
      "openid",
  ...
  },
  {
    ...
    back_channel_logout_uri = "https://acceptance-test-rp-build.build.stubs.account.gov.uk/backchannel_logout"
    test_client             = "1"
    client_type             = "web"
    scopes = [
      "openid",
