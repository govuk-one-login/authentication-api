    ...
    void setUp() {
        handler =
                new IPVCallbackHandler(
                        ...
                        ipvCallbackHelper,
                        frontEndPages);
        when(frontEndPages.ipvCallbackURI()).thenReturn(FRONT_END_IPV_CALLBACK_URI);
        when(frontEndPages.errorIpvCallbackURI()).thenReturn(FRONT_END_IPV_CALLBACK_ERROR_URI);
