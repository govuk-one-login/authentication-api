...
public class IPVAuthorisationHandlerAfterSplitTest {
    ...
    private IPVAuthorisationHandlerAfterSplit handler;
    ...
    void setup() {
        ...
        handler =
                new IPVAuthorisationHandlerAfterSplit(
                        configService,
                        sessionService,
    ...
    @Test
    void shouldReturnRedirectUriWithClaims() throws JOSEException, ParseException {
