                ...
                .body(
                        new PactDslJsonBody()
                            ...
                            .maxArrayLike("https://vocab.account.gov.uk/v1/address", 1)
                                .stringTypes("addressCountry", "uprn", "buildingName", "streetName", "postalCode", "buildingNumber", "addressLocality", "validFrom")
                                .closeObject()
                            .closeArray()
                            .maxArrayLike("https://vocab.account.gov.uk/v1/drivingPermit", 1)
                                .stringTypes("addressCountry", "uprn", "buildingName", "streetName", "postalCode", "buildingNumber", "addressLocality", "validFrom")
                                .closeObject()
                            .closeArray()
                            .maxArrayLike("https://vocab.account.gov.uk/v1/socialSecurityRecord", 1)
                                .maxArrayLike("socialSecurityRecord", 1)
                                    .stringType("personalNumber")
                                    .closeObject()
                                .closeArray()
                                .closeObject()
                            .closeArray()
                            .maxArrayLike("https://vocab.account.gov.uk/v1/passport", 1)
                                .stringTypes("documentNumber", "expiryDate")
                                .closeObject()
                            .closeArray()
                )
                .toPact();
