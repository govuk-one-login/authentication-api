...
public class IPVTest {
    ...
    V4Pact success(PactBuilder builder) {
        return builder
                .expectsToReceive("request for a IPV", "")
                .with(
                        Map.of(
    ...
    void getCsvReport(MockServer mockServer) throws IOException, Json.JsonException, UnsuccessfulCredentialResponseException {
