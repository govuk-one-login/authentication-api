    ...
    public boolean hasRateLimitExceeded(ClientRateLimitConfig rateLimitConfig) {
        ...
        long currentCount =
                rateLimitDataService
                        ...
                        .map(ClientRateLimitData::getRequestCount)
                        .orElse(0L);
        long previousCount =
                rateLimitDataService
        ...
        var secondsFromPreviousPeriodInWindow =
                WINDOW_SIZE_IN_SECONDS - secondsFromCurrentPeriodInWindow;
        ...
        var previousCountInWindow =
                previousCount
                        * ((double) secondsFromPreviousPeriodInWindow / WINDOW_SIZE_IN_SECONDS);
