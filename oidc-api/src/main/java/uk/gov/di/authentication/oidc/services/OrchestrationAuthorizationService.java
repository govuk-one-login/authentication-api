...
public class OrchestrationAuthorizationService {
    ...
    /*public VectorOfTrustLegacy getEffectiveVectorOfTrust(AuthenticationRequest authenticationRequest) {
        return VectorOfTrustLegacy.orderVtrList(getVtrList(authenticationRequest)).get(0);
    }*/

    public VtrRequest getVtrRequest(AuthenticationRequest authenticationRequest) {
        return VtrRequest.parseFromAuthRequestAttribute(
