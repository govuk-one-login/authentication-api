...
public class ClientRateLimitData {
    ...
    public ClientRateLimitData withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    ...
    public ClientRateLimitData withPeriodStartTime(LocalDateTime periodStartTime) {
        this.periodStartTime = periodStartTime;
        return this;
    }
    ...
    public ClientRateLimitData withRequestCount(Long requestCount) {
        this.requestCount = requestCount;
        return this;
    }
    ...
    public ClientRateLimitData withTimeToLive(long timeToLive) {
        this.timeToLive = timeToLive;
        return this;
    }
}
